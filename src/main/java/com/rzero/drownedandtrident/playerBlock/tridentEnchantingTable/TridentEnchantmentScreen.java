...
public class TridentEnchantmentScreen extends AbstractContainerScreen<TridentEnchantmentMenu> {
    ...
    public TridentEnchantmentScreen(TridentEnchantmentMenu p_98754_, Inventory p_98755_, Component p_98756_) {
