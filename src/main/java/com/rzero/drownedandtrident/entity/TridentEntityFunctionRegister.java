...
public class TridentEntityFunctionRegister {
    ...
    public static final DeferredRegister<EntityType<?>> OVERRIDE_ENTITY_TYPE =
            DeferredRegister.create(BuiltInRegistries.ENTITY_TYPE, DrownedAndTridentMod.MODID);
...
//            OVERRIDE_ENTITY_TYPE.register("DAT_thrown_trident", () -> .ATTACK_PROTECT_LIGHTNING);
