...
public class ThunderTrajectoryEnchantment extends BaseCustomEnchantment implements EnchantmentEntityEffect, BaseEnchantmentDefinition {
    ...
    public void apply(ServerLevel level, int enchantmentLevel, EnchantedItemInUse item, Entity entity, Vec3 origin) {
        ...
        if (!(entity instanceof ThrownTrident thrownTrident)) return;
        ...
        if (upgradeStatus == 0) {
             ...
             */
            if (thrownTridentMixinExt.drownedandtrident$getThunderTrajectoryTriggerCountTick() == 2 ||
                    thrownTridentMixinExt.drownedandtrident$getThunderTrajectoryTriggerCountTick() == 5)
